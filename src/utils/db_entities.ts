...
import {DocsEntity} from "../docs/entity/docs.entity";
import {OfpEntity} from "../ofp/entity/ofp.entity";
import {StandardEntity} from "../standards/entity/standard.entity";


export const DB_ENTITIES = [UserEntity,ClubEntity, SportsmanEntity,NewsEntity,EventEntity, DocsEntity, OfpEntity, StandardEntity];